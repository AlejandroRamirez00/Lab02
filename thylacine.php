...
<html lang="en">
	...
	<body>
		...
		<article>
			...
			<!-- Info on figure and figcaption tags from http://www.w3schools.com -->
			<figure>
				<img src="images/thylacine_cubs.jpg" alt="Thylacine Cubs">
				<figcaption>A thylacine family in captivity</figcaption>
			</figure>
			<p>
			...
			<h2>"Benjamin" and Searches</h2>
			<figure>
				<img src="images/benjamin.jpg" alt="Benjamin, the Last Thylacine">
				<figcaption>Benjamin, the last known thylacine, showing the animal's signature yawn</figcaption>
			</figure>  
		...
		<aside>
			<h2>Miscellaneous Unconfirmed Sightings:</h2>
			<figure>
				<img src="images/two_thylacines.jpg" alt="A Pair of Thylacines in Captivity">
				<figcaption>A male and female pair in captivity</figcaption>
			</figure>
			...
			<ul>
				<li>65 sightings reported in Western Australia over 50 years</li>
				<li>1 sighting in 1982 by the Arthur River in northwestern Tasmania</li>
				<li>1 sighting (with inconclusive photographic evidence) in 1985 in Western Australia</li>
				<li>1 sighting at the Pyengana region of northeastern Tasmania (no evidence)</li>
				<li>Several sightings in 1997 near Mount Carstensz in Western New Guinea</li>
				<li>1 sighting in 2005 at Lake St Clair National Park (inconclusive photographic evidence)</li>
				<li>2 sightings in North Queensland</li>
				<li>8 sightings between 2016 and 2019 in Tasmania</li>
			</ul>
			...
			<h2>Related Topics:</h2>
				...
				<ul>
					<li>De-extinction / Breeding back</li>
					<li>Fauna of Australia</li>
					<li>List of extinct animals of Australia</li>
					<li>Savage River National Park</li>
		...
		<footer>
			<h2>Citations:</h2>
				...
				<ul>
					<li>
						Geoffroy-Saint-Hilaire, [Étienne] (1810). <a href="https://www.biodiversitylibrary.org/page/3546569#page/351/mode/1up">“Description de deux espèces de Dasyures (Dasyures cynocephalus et Dasyurus ursinus)”</a>. Annales du Muséum National d'Histoire Naturelle. 15: 301–306. Archived from the original on 2 August 2017. Retrieved 21 February 2018.
					</li>

					<li>
						Groves, C.P. (2005). <a href="https://books.google.com/books?id=JgAMbNSt8ikC&pg=PA23#v=onepage&q&f=false">“Order Dasyuromorphia”</a>. In Wilson, D.E.; Reeder, D.M (eds.). Mammal Species of the World: A Taxonomic and Geographical Reference (3rd ed.). Johns Hopkins University Press. p. 23. ISBN 978-0-8018-8221-0. OCLO 62265494.
					</li>

					<li>
						Piper, Katarzyna J. (2007). "<a href="https://www.tandfonline.com/doi/abs/10.1671/0272-4634%282007%2927%5B492%3AEPMFTN%5D2.0.CO%3B2">Early Pleistocene mammals from the Nelson Bay local fauna, Portland, Victoria, Australia"</a>. Journal of Vertebrate Paleontology. 27 (2): 492–503.
					</li>
				</ul>
				...
				<p>
					<a href="https://en.wikipedia.org/wiki/Thylacine">Wikipedia "Thylacine"</a>
				</p>
